...
# Google 인증 콜백 라우트
@main_bp.route('/login_google/callback/google_auth')
def google_auth_callback():
    ...
    try:
        ...
        return "Successfully authorized with Google!"

    except Exception as e:
        print("Error during token exchange:", e)
        return "Error during token exchange: {}".format(e)
